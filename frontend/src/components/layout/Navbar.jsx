    ...
    <nav className="navbar">
      <div className="container">
        ...
        <div className="navbar-links">
          <a href="#features" className="navbar-link">Solución</a>
          <a href="#how-it-works" className="navbar-link">Cómo funciona</a>
          <a href="#questionnaire" className="navbar-link">Cuestionario</a>
          <a href="#benefits" className="navbar-link">Resultados</a>
        </div>
