...
function AdminUsuarios() {
  ...
  const rowActions = [
    ...
    { label: 'Cambiar contraseña', icon: <FiLock size={14} />, onClick: (row) => notify(`Cambiando contraseña de ${row.name}...`) },
  ...
  return (
    <>
      <PageHeader
        ...
        actions={<Button variant="primary" onClick={() => notify('Abriendo formulario de nuevo usuario...')}><FiPlus size={16} /> Nuevo usuario</Button>}
      />
      <DataTable
        columns={columns}
        data={users}
